...
abstract class $AuthTokenCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, String? refreshToken, DateTime expiry});
}
...
class _$AuthTokenImpl extends _AuthToken {
  const _$AuthTokenImpl(
      {required this.accessToken, this.refreshToken, required this.expiry})
      : super._();
  ...
  @override
  String toString() {
    return 'AuthToken(accessToken: $accessToken, refreshToken: $refreshToken, expiry: $expiry)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, expiry);
...
abstract class _AuthToken extends AuthToken {
  const factory _AuthToken(
      ...
      final String? refreshToken,
      required final DateTime expiry}) = _$AuthTokenImpl;
